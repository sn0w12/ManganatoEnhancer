function log(text, category = "", type = "info") {
...
function fixStyles() {
    const topDiv = document.querySelector(".silder-title");
    if (topDiv) {
        topDiv.style.width = "100%";
    }

    const panelDiv = document.querySelector(".panel-topview-title");
    if (panelDiv) {
        panelDiv.style.width = "100%";
    }

    const categoryDiv = document.querySelector(".pn-category-story-title");
    if (categoryDiv) {
...
function addScrollButtons() {
    ...
    function scrollToImage(index, position) {
